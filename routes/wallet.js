...
const daraja = require("../services/daraja");     // still used for the B2C payout itself
const payhero = require("../services/payhero");    // used for the fee STK push
  ...
  async (req, res) => {
    ...
    try {
      ...
      if (method === "mpesa") {
        ...
        // PayHero's initiation response only gives { success, status, reference,
        // CheckoutRequestID } — no MerchantRequestID until the callback fires.
